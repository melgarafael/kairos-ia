-- v55 – Agent Prompts: adicionar coluna tone_of_voice e atualizar RPC upsert

BEGIN;

-- 1) Nova coluna opcional para tonalidade da voz do agente
alter table if exists public.agent_prompts
  add column if not exists tone_of_voice text null;

-- 2) Upsert: incluir p_tone_of_voice e definir coluna
